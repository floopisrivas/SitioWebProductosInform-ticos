...
namespace GeneXus.Programs {
   public class articulodetallewc : GXWebComponent, System.Web.SessionState.IRequiresSessionState
   {
      public articulodetallewc( )
      {
      ...
      public articulodetallewc( IGxContext context )
      {
         ...
         if ( StringUtil.Len( (string)(sPrefix)) == 0 )
         {
            if ( nGotPars == 0 )
            {
               ...
               else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Grid") == 0 )
               {
                  ...
                  gxgrGrid_refresh( subGrid_Rows, AV6ArticuloId, AV12Update, AV13Delete, sPrefix) ;
      ...
      protected void RenderHtmlOpenForm( )
      {
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.SendWebValue( "Articulo Detalle WC") ;
         ...
         context.AddJavascriptSource("gxcfg.js", "?2021111616522798", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            if ( nGXWrapped != 1 )
            {
               context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("articulodetallewc.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV6ArticuloId,4,0))}, new string[] {"ArticuloId"}) +"\">") ;
      ...
      {
         return "ArticuloDetalleWC" ;
      }

      public override string GetPgmdesc( )
      {
         return "Articulo Detalle WC" ;
      }
      ...
      protected void WB1E0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            if ( StringUtil.Len( sPrefix) != 0 )
            {
               GxWebStd.gx_hidden_field( context, sPrefix+"_CMPPGM", "articulodetallewc.aspx");
            }
            /* Div Control */
            ...
            ClassString = "BtnAdd";
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtninsert_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(20), 2, 0)+","+"null"+");", "Insert", bttBtninsert_Jsonclick, 5, "Insert", "", StyleString, ClassString, 1, 1, "rounded", "'"+sPrefix+"'"+",false,"+"'"+sPrefix+"E\\'DOINSERT\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_ArticuloDetalleWC.htm");
            ...
            if ( GridContainer.GetWrapped() == 1 )
            {
               ...
               context.WriteHtmlTextNl( "</th>") ;
               context.WriteHtmlText( "<th align=\""+"left"+"\" "+" nowrap=\"nowrap\" "+" class=\""+"Attribute"+"\" "+" style=\""+""+""+"\" "+">") ;
               context.SendWebValue( "Cliente Descripcion") ;
               context.WriteHtmlTextNl( "</th>") ;
               context.WriteHtmlText( "<th align=\""+"right"+"\" "+" nowrap=\"nowrap\" "+" class=\""+"Attribute"+"\" "+" style=\""+""+""+"\" "+">") ;
            ...
            else
            {
               ...
               GridContainer.AddColumnProperties(GridColumn);
               GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
               GridColumn.AddObjectProperty("Value", StringUtil.LTrim( StringUtil.NToC( (decimal)(A21ClienteId), 4, 0, ".", "")));
               GridContainer.AddColumnProperties(GridColumn);
               GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
               GridColumn.AddObjectProperty("Value", A22ClienteDescripcion);
               GridContainer.AddColumnProperties(GridColumn);
               GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
      ...
      protected void START1E2( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            if ( ! context.isSpaRequest( ) )
            {
               ...
               Form.Meta.addItem("description", "Articulo Detalle WC", 0) ;
            }
            context.wjLoc = "";
      ...
      protected void RF1E2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               A1ArticuloId = H001E3_A1ArticuloId[0];
               AssignAttri(sPrefix, false, "A1ArticuloId", StringUtil.LTrimStr( (decimal)(A1ArticuloId), 4, 0));
               A59FormaPagoNombre = H001E3_A59FormaPagoNombre[0];
               A58FormaPagoId = H001E3_A58FormaPagoId[0];
               A20EmpleadoCargo = H001E3_A20EmpleadoCargo[0];
               A19EmpleadoId = H001E3_A19EmpleadoId[0];
               A22ClienteDescripcion = H001E3_A22ClienteDescripcion[0];
               A21ClienteId = H001E3_A21ClienteId[0];
               A55FacturaTipo = H001E3_A55FacturaTipo[0];
               A34FechaFactura = H001E3_A34FechaFactura[0];
               A33FacturaId = H001E3_A33FacturaId[0];
               A71FacturaTotIva = H001E3_A71FacturaTotIva[0];
               A52FacturaSubtotal = H001E3_A52FacturaSubtotal[0];
               A58FormaPagoId = H001E3_A58FormaPagoId[0];
               A19EmpleadoId = H001E3_A19EmpleadoId[0];
               A21ClienteId = H001E3_A21ClienteId[0];
               A55FacturaTipo = H001E3_A55FacturaTipo[0];
      ...
      protected int subGrid_fnc_Recordcount( )
      {
         ...
         GRID_nRecordCount = H001E5_AGRID_nRecordCount[0];
         pr_default.close(1);
      ...
      public override void componentprepare( Object[] obj )
      {
         ...
         AddComponentObject(sPrefix, "articulodetallewc", GetJustCreated( ));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2021111616522883", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            context.AddJavascriptSource("articulodetallewc.js", "?2021111616522883", false, true);
         }
      ...
      protected void SubsflControlProps_202( )
      {
         ...
         edtClienteDescripcion_Internalname = sPrefix+"CLIENTEDESCRIPCION_"+sGXsfl_20_idx;
      ...
      protected void SubsflControlProps_fel_202( )
      {
         ...
         edtClienteDescripcion_Internalname = sPrefix+"CLIENTEDESCRIPCION_"+sGXsfl_20_fel_idx;
      ...
      protected void sendrow_202( )
      {
         ...
         if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_20_idx <= subGrid_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtClienteId_Internalname,StringUtil.LTrim( StringUtil.NToC( (decimal)(A21ClienteId), 4, 0, ".", "")),context.localUtil.Format( (decimal)(A21ClienteId), "ZZZ9"),(string)"",(string)"'"+sPrefix+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtClienteId_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"WWColumn WWOptionalColumn",(string)"",(short)-1,(short)0,(short)0,(string)"number",(string)"1",(short)0,(string)"px",(short)17,(string)"px",(short)4,(short)0,(short)0,(short)20,(short)1,(short)-1,(short)0,(bool)true,(string)"Id",(string)"right",(bool)false,(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+""+"\">") ;
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtClienteDescripcion_Internalname,(string)A22ClienteDescripcion,(string)"",(string)"",(string)"'"+sPrefix+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtClienteDescripcion_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"WWColumn WWOptionalColumn",(string)"",(short)-1,(short)0,(short)0,(string)"text",(string)"",(short)0,(string)"px",(short)17,(string)"px",(short)80,(short)0,(short)0,(short)20,(short)1,(short)-1,(short)-1,(bool)true,(string)"",(string)"left",(bool)true,(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"right"+"\""+" style=\""+""+"\">") ;
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV6ArticuloId',fld:'vARTICULOID',pic:'ZZZ9'},{av:'AV12Update',fld:'vUPDATE',pic:''},{av:'AV13Delete',fld:'vDELETE',pic:''},{av:'sPrefix'}]");
         setEventMetadata("REFRESH",",oparms:[]}");
         setEventMetadata("GRID.LOAD","{handler:'E131E2',iparms:[{av:'A33FacturaId',fld:'FACTURAID',pic:'ZZZ9',hsh:true},{av:'A58FormaPagoId',fld:'FORMAPAGOID',pic:'ZZZ9'}]");
         ...
         setEventMetadata("'DOINSERT'","{handler:'E111E2',iparms:[{av:'A33FacturaId',fld:'FACTURAID',pic:'ZZZ9',hsh:true}]");
         setEventMetadata("'DOINSERT'",",oparms:[]}");
         setEventMetadata("GRID_FIRSTPAGE","{handler:'subgrid_firstpage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV6ArticuloId',fld:'vARTICULOID',pic:'ZZZ9'},{av:'AV12Update',fld:'vUPDATE',pic:''},{av:'AV13Delete',fld:'vDELETE',pic:''},{av:'sPrefix'}]");
         setEventMetadata("GRID_FIRSTPAGE",",oparms:[]}");
         setEventMetadata("GRID_PREVPAGE","{handler:'subgrid_previouspage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV6ArticuloId',fld:'vARTICULOID',pic:'ZZZ9'},{av:'AV12Update',fld:'vUPDATE',pic:''},{av:'AV13Delete',fld:'vDELETE',pic:''},{av:'sPrefix'}]");
         setEventMetadata("GRID_PREVPAGE",",oparms:[]}");
         setEventMetadata("GRID_NEXTPAGE","{handler:'subgrid_nextpage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV6ArticuloId',fld:'vARTICULOID',pic:'ZZZ9'},{av:'AV12Update',fld:'vUPDATE',pic:''},{av:'AV13Delete',fld:'vDELETE',pic:''},{av:'sPrefix'}]");
         setEventMetadata("GRID_NEXTPAGE",",oparms:[]}");
         setEventMetadata("GRID_LASTPAGE","{handler:'subgrid_lastpage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV6ArticuloId',fld:'vARTICULOID',pic:'ZZZ9'},{av:'AV12Update',fld:'vUPDATE',pic:''},{av:'AV13Delete',fld:'vDELETE',pic:''},{av:'sPrefix'}]");
      ...
      public override void initialize( )
      {
         ...
         sEvtType = "";
         scmdbuf = "";
         H001E3_A1ArticuloId = new short[1] ;
         H001E3_A59FormaPagoNombre = new string[] {""} ;
         H001E3_A58FormaPagoId = new short[1] ;
         H001E3_A20EmpleadoCargo = new string[] {""} ;
         H001E3_A19EmpleadoId = new short[1] ;
         H001E3_A22ClienteDescripcion = new string[] {""} ;
         H001E3_A21ClienteId = new short[1] ;
         H001E3_A55FacturaTipo = new string[] {""} ;
         H001E3_A34FechaFactura = new DateTime[] {DateTime.MinValue} ;
         H001E3_A33FacturaId = new short[1] ;
         H001E3_A71FacturaTotIva = new decimal[1] ;
         H001E3_A52FacturaSubtotal = new decimal[1] ;
         H001E5_AGRID_nRecordCount = new long[1] ;
         ...
         sCtrlAV6ArticuloId = "";
         ROClassString = "";
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.articulodetallewc__default(),
            new Object[][] {
                new Object[] {
               H001E3_A1ArticuloId, H001E3_A59FormaPagoNombre, H001E3_A58FormaPagoId, H001E3_A20EmpleadoCargo, H001E3_A19EmpleadoId, H001E3_A22ClienteDescripcion, H001E3_A21ClienteId, H001E3_A55FacturaTipo, H001E3_A34FechaFactura, H001E3_A33FacturaId,
               H001E3_A71FacturaTotIva, H001E3_A52FacturaSubtotal
               }
               , new Object[] {
               H001E5_AGRID_nRecordCount
               }
            }
         );
         AV17Pgmname = "ArticuloDetalleWC";
      ...
      private short[] H001E3_A1ArticuloId ;
      private string[] H001E3_A59FormaPagoNombre ;
      private short[] H001E3_A58FormaPagoId ;
      private string[] H001E3_A20EmpleadoCargo ;
      private short[] H001E3_A19EmpleadoId ;
      private string[] H001E3_A22ClienteDescripcion ;
      private short[] H001E3_A21ClienteId ;
      private string[] H001E3_A55FacturaTipo ;
      private DateTime[] H001E3_A34FechaFactura ;
      private short[] H001E3_A33FacturaId ;
      private decimal[] H001E3_A71FacturaTotIva ;
      private decimal[] H001E3_A52FacturaSubtotal ;
      private long[] H001E5_AGRID_nRecordCount ;
   ...
   public class articulodetallewc__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H001E3", "SELECT T1.[ArticuloId], T3.[FormaPagoNombre], T2.[FormaPagoId], T4.[EmpleadoCargo], T2.[EmpleadoId], T5.[ClienteDescripcion], T2.[ClienteId], T2.[FacturaTipo], T2.[FechaFactura], T1.[FacturaId], COALESCE( T6.[FacturaTotIva], 0) AS FacturaTotIva, COALESCE( T6.[FacturaSubtotal], 0) AS FacturaSubtotal FROM ((((([FacturaDetalle] T1 INNER JOIN [Factura] T2 ON T2.[FacturaId] = T1.[FacturaId]) INNER JOIN [FormaPago] T3 ON T3.[FormaPagoId] = T2.[FormaPagoId]) INNER JOIN [Empleado] T4 ON T4.[EmpleadoId] = T2.[EmpleadoId]) INNER JOIN [Cliente] T5 ON T5.[ClienteId] = T2.[ClienteId]) LEFT JOIN (SELECT SUM([FacturaCantidad] * CAST([PrecioArticuloVenta] AS decimal( 18, 10))) AS FacturaSubtotal, [FacturaId], SUM(( [FacturaCantidad] * CAST([PrecioArticuloVenta] AS decimal( 18, 10))) * CAST(CAST(21 AS decimal( 13, 10)) / 100 AS decimal( 24, 10))) AS FacturaTotIva FROM [FacturaDetalle] GROUP BY [FacturaId] ) T6 ON T6.[FacturaId] = T1.[FacturaId]) WHERE T1.[ArticuloId] = @AV6ArticuloId ORDER BY T1.[ArticuloId]  OFFSET @GXPagingFrom2 ROWS FETCH NEXT CAST((SELECT CASE WHEN @GXPagingTo2 > 0 THEN @GXPagingTo2 ELSE 1e9 END) AS INTEGER) ROWS ONLY",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH001E3,11, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("H001E5", "SELECT COUNT(*) FROM ((((([FacturaDetalle] T1 INNER JOIN [Factura] T2 ON T2.[FacturaId] = T1.[FacturaId]) INNER JOIN [FormaPago] T5 ON T5.[FormaPagoId] = T2.[FormaPagoId]) INNER JOIN [Empleado] T3 ON T3.[EmpleadoId] = T2.[EmpleadoId]) INNER JOIN [Cliente] T4 ON T4.[ClienteId] = T2.[ClienteId]) LEFT JOIN (SELECT SUM([FacturaCantidad] * CAST([PrecioArticuloVenta] AS decimal( 18, 10))) AS FacturaSubtotal, [FacturaId], SUM(( [FacturaCantidad] * CAST([PrecioArticuloVenta] AS decimal( 18, 10))) * CAST(CAST(21 AS decimal( 13, 10)) / 100 AS decimal( 24, 10))) AS FacturaTotIva FROM [FacturaDetalle] GROUP BY [FacturaId] ) T6 ON T6.[FacturaId] = T1.[FacturaId]) WHERE T1.[ArticuloId] = @AV6ArticuloId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH001E5,1, GxCacheFrequency.OFF ,true,false )
          };
       }
    }
