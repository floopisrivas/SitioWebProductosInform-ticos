...
namespace GeneXus.Programs {
   public class wwusuario : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?2021111616524325", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
      ...
      protected void WB2B0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTitletext_Internalname, "usuarios", "", "", lblTitletext_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "SubTitle", 0, "", 1, 1, 0, 0, "HLP_WWusuario.htm");
            ...
            ClassString = "BtnAdd";
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtninsert_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(22), 2, 0)+","+"null"+");", "Insert", bttBtninsert_Jsonclick, 5, "Insert", "", StyleString, ClassString, 1, 1, "rounded", "'"+""+"'"+",false,"+"'"+"E\\'DOINSERT\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_WWusuario.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            if ( GridContainer.GetWrapped() == 1 )
            {
               ...
               context.WriteHtmlTextNl( "</th>") ;
               context.WriteHtmlText( "<th align=\""+"left"+"\" "+" nowrap=\"nowrap\" "+" class=\""+"Attribute"+"\" "+" style=\""+""+""+"\" "+">") ;
               context.SendWebValue( "Rol Nombre") ;
               context.WriteHtmlTextNl( "</th>") ;
            ...
            else
            {
               ...
               GridColumn.AddObjectProperty("Value", A48usuario);
               GridContainer.AddColumnProperties(GridColumn);
               GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
               GridColumn.AddObjectProperty("Value", StringUtil.RTrim( A90usuarioNombre));
               GridContainer.AddColumnProperties(GridColumn);
               GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
               GridColumn.AddObjectProperty("Value", A49clave);
               GridContainer.AddColumnProperties(GridColumn);
               GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
               GridColumn.AddObjectProperty("Value", A54RolNombre);
               GridContainer.AddColumnProperties(GridColumn);
               GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
                     ...
                     if ( StringUtil.StrCmp(sEvtType, "E") == 0 )
                     {
                        ...
                        else
                        {
                           ...
                           if ( ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "START") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 7), "REFRESH") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 9), "GRID.LOAD") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "ENTER") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 6), "CANCEL") == 0 ) )
                           {
                              ...
                              A48usuario = cgiGet( edtusuario_Internalname);
                              A90usuarioNombre = cgiGet( edtusuarioNombre_Internalname);
                              A49clave = cgiGet( edtclave_Internalname);
                              A54RolNombre = cgiGet( edtRolNombre_Internalname);
      ...
      {
         GxWebStd.gx_hidden_field( context, "gxhash_USUARIO", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( A48usuario, "")), context));
         GxWebStd.gx_hidden_field( context, "USUARIO", A48usuario);
      }
      ...
      protected void RF2B2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               A53RolId = H002B2_A53RolId[0];
               A54RolNombre = H002B2_A54RolNombre[0];
               A49clave = H002B2_A49clave[0];
               A90usuarioNombre = H002B2_A90usuarioNombre[0];
               A48usuario = H002B2_A48usuario[0];
               A54RolNombre = H002B2_A54RolNombre[0];
               E142B2 ();
      ...
      {
         GxWebStd.gx_hidden_field( context, "gxhash_USUARIO"+"_"+sGXsfl_22_idx, GetSecureSignedToken( sGXsfl_22_idx, StringUtil.RTrim( context.localUtil.Format( A48usuario, "")), context));
      }
      ...
      private void E142B2( )
      {
         /* Grid_Load Routine */
         returnInSub = false;
         edtavUpdate_Link = formatLink("usuario.aspx", new object[] {UrlEncode(StringUtil.RTrim("UPD")),UrlEncode(StringUtil.RTrim(A48usuario))}, new string[] {"Mode","usuario"}) ;
         edtavDelete_Link = formatLink("usuario.aspx", new object[] {UrlEncode(StringUtil.RTrim("DLT")),UrlEncode(StringUtil.RTrim(A48usuario))}, new string[] {"Mode","usuario"}) ;
         /* Load Method */
         if ( wbStart != -1 )
         {
            wbStart = 22;
      ...
      protected void E112B2( )
      {
         /* 'DoInsert' Routine */
         returnInSub = false;
         CallWebObject(formatLink("usuario.aspx", new object[] {UrlEncode(StringUtil.RTrim("INS")),UrlEncode(StringUtil.RTrim(""))}, new string[] {"Mode","usuario"}) );
         context.wjLocDisableFrm = 1;
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2021111616524355", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            ...
            context.AddJavascriptSource("wwusuario.js", "?2021111616524355", false, true);
         }
      ...
      {
         edtusuario_Internalname = "USUARIO_"+sGXsfl_22_idx;
         edtusuarioNombre_Internalname = "USUARIONOMBRE_"+sGXsfl_22_idx;
         edtclave_Internalname = "CLAVE_"+sGXsfl_22_idx;
         edtRolNombre_Internalname = "ROLNOMBRE_"+sGXsfl_22_idx;
      ...
      {
         edtusuario_Internalname = "USUARIO_"+sGXsfl_22_fel_idx;
         edtusuarioNombre_Internalname = "USUARIONOMBRE_"+sGXsfl_22_fel_idx;
         edtclave_Internalname = "CLAVE_"+sGXsfl_22_fel_idx;
         edtRolNombre_Internalname = "ROLNOMBRE_"+sGXsfl_22_fel_idx;
      ...
      protected void sendrow_222( )
      {
         ...
         if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_22_idx <= subGrid_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtusuario_Internalname,(string)A48usuario,(string)"",(string)"",(string)"'"+""+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtusuario_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"WWColumn WWOptionalColumn",(string)"",(short)-1,(short)0,(short)0,(string)"text",(string)"",(short)0,(string)"px",(short)17,(string)"px",(short)40,(short)0,(short)0,(short)22,(short)1,(short)-1,(short)-1,(bool)true,(string)"",(string)"left",(bool)true,(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+""+"\">") ;
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtclave_Internalname,(string)A49clave,(string)"",(string)"",(string)"'"+""+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtclave_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"WWColumn WWOptionalColumn",(string)"",(short)-1,(short)0,(short)0,(string)"text",(string)"",(short)0,(string)"px",(short)17,(string)"px",(short)10,(short)0,(short)0,(short)22,(short)1,(short)-1,(short)-1,(bool)true,(string)"",(string)"left",(bool)true,(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+""+"\">") ;
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtRolNombre_Internalname,(string)A54RolNombre,(string)"",(string)"",(string)"'"+""+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtRolNombre_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"WWColumn WWOptionalColumn",(string)"",(short)-1,(short)0,(short)0,(string)"text",(string)"",(short)0,(string)"px",(short)17,(string)"px",(short)40,(short)0,(short)0,(short)22,(short)1,(short)-1,(short)-1,(bool)true,(string)"",(string)"left",(bool)true,(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+""+"\">") ;
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("GRID.LOAD","{handler:'E142B2',iparms:[{av:'A48usuario',fld:'USUARIO',pic:'',hsh:true}]");
         setEventMetadata("GRID.LOAD",",oparms:[{av:'edtavUpdate_Link',ctrl:'vUPDATE',prop:'Link'},{av:'edtavDelete_Link',ctrl:'vDELETE',prop:'Link'}]}");
         setEventMetadata("'DOINSERT'","{handler:'E112B2',iparms:[{av:'A48usuario',fld:'USUARIO',pic:'',hsh:true}]");
      ...
      public override void initialize( )
      {
         ...
         AV16Pgmname = "";
         scmdbuf = "";
         H002B2_A53RolId = new short[1] ;
         H002B2_A54RolNombre = new string[] {""} ;
         H002B2_A49clave = new string[] {""} ;
         H002B2_A90usuarioNombre = new string[] {""} ;
         H002B2_A48usuario = new string[] {""} ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.wwusuario__default(),
            new Object[][] {
                new Object[] {
               H002B2_A53RolId, H002B2_A54RolNombre, H002B2_A49clave, H002B2_A90usuarioNombre, H002B2_A48usuario
               }
               , new Object[] {
      ...
      private string A90usuarioNombre ;
      ...
      private string edtclave_Internalname ;
      ...
      private string edtclave_Jsonclick ;
      ...
      private string A48usuario ;
      private string A49clave ;
      private string A54RolNombre ;
      ...
      private short[] H002B2_A53RolId ;
      private string[] H002B2_A54RolNombre ;
      private string[] H002B2_A49clave ;
      private string[] H002B2_A90usuarioNombre ;
      private string[] H002B2_A48usuario ;
   ...
   public class wwusuario__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H002B2", "SELECT T1.[RolId], T2.[RolNombre], T1.[clave], T1.[usuarioNombre], T1.[usuario] FROM ([usuario] T1 INNER JOIN [Rol] T2 ON T2.[RolId] = T1.[RolId]) ORDER BY T1.[usuario]  OFFSET @GXPagingFrom2 ROWS FETCH NEXT CAST((SELECT CASE WHEN @GXPagingTo2 > 0 THEN @GXPagingTo2 ELSE 1e9 END) AS INTEGER) ROWS ONLY",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH002B2,11, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("H002B3", "SELECT COUNT(*) FROM ([usuario] T1 INNER JOIN [Rol] T2 ON T2.[RolId] = T1.[RolId]) ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH002B3,1, GxCacheFrequency.OFF ,true,false )
          };
       }
    }
